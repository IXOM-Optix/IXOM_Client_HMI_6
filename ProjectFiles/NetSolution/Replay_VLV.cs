...
public class Replay_VLV : BaseNetLogic
{
  ...
  string itemRtn;
    ...
    private void ReplayTime_VariableChange(object sender, VariableChangeEventArgs e)
      {
        ...
        _Position_Actual = LogicObject.GetVariable("Replay/Position_Actual");
    ...
    //Position_Actual
     //Query value from Position_Actual
     ...
     //Store Valuefrom Query
      _Position_Actual.Value = (dynamic)resultSet[0, 0];
